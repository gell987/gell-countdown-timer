...
async function greet() {
    console.clear();
    const rainboxTitle = chalk.blue.bold("Hassam's countdown timer PIAIC(PIAIC202061)\n");
...
let intervalId;
async function main() {
    console.log(chalk.redBright("Enter the amount of hours, minutes, and seconds for the countdown:"));
    ...
    const countdown = () => {
        intervalId = setInterval(async () => {
            ...
            process.stdout.write(`${chalk.redBright(hours)}:${chalk.greenBright(minutes)}:${chalk.redBright(seconds)}`);
        }, 1000);
    };
